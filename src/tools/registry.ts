/**
 * Tool registry for Bahrain Law MCP Server.
...
import { getBahrainiImplementations, type GetBahrainiImplementationsInput } from './get-bahraini-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Bahrain Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Bahraini legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Bahraini statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section/article) from a Bahraini statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Bahraini legal citation against the database — zero-hallucination check. ' +
      ...
      'Supports formats: "Section 25, Data Protection Act 2019", "s 25, DPA 2019", "Article 31, Constitution of Bahrain 2010".',
    inputSchema: {
      type: 'object',
      properties: {
        citation: {
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Bahraini statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Bahrain?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Bahraini legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Bahraini statute or provision is currently in force, amended, repealed, partially suspended, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Bahraini statute aligns with or references. ' +
      'Bahrain is not an EU member but several Bahraini laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Bahraini statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_bahraini_implementations',
    description:
      'Find all Bahraini statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Bahraini statutes. ' +
      'Note: Bahrain implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Bahraini implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_bahraini_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Bahraini aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Bahraini statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Bahraini statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_bahraini_implementations':
          result = await getBahrainiImplementations(db, args as unknown as GetBahrainiImplementationsInput);
          break;
