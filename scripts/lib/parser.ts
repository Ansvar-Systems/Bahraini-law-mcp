...
export function parseHtml(_html: string, _act: ActIndexEntry): ParsedAct {
  throw new Error(
    'Parser not yet implemented for Bahrain. ' +
    'Implement this function to parse HTML from legalaffairs.gov.bh.'
  );
}
